...
public class FrameCobrarTransferencias extends JInternalFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(cboMiembro, javax.swing.GroupLayout.PREFERRED_SIZE, 266, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(masterScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 382, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private class FormListener implements java.awt.event.ActionListener, java.awt.event.FocusListener, java.awt.event.KeyListener, java.awt.event.MouseListener, javax.swing.event.InternalFrameListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                FrameCobrarTransferencias.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                FrameCobrarTransferencias.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                FrameCobrarTransferencias.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                FrameCobrarTransferencias.this.deleteButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton1) {
                FrameCobrarTransferencias.this.newButton1ActionPerformed(evt);
            }
            else if (evt.getSource() == txtCtaCte) {
                FrameCobrarTransferencias.this.txtCtaCteActionPerformed(evt);
            }
            else if (evt.getSource() == cboMiembro) {
                FrameCobrarTransferencias.this.cboMiembroActionPerformed(evt);
            }
            else if (evt.getSource() == cboEvento) {
                FrameCobrarTransferencias.this.cboEventoActionPerformed(evt);
            }
            else if (evt.getSource() == montoField) {
                FrameCobrarTransferencias.this.montoFieldActionPerformed(evt);
            }
            else if (evt.getSource() == cboEventoTipo) {
                FrameCobrarTransferencias.this.cboEventoTipoActionPerformed(evt);
            }
        }

        public void focusGained(java.awt.event.FocusEvent evt) {
            if (evt.getSource() == txtCtaCte) {
                FrameCobrarTransferencias.this.txtCtaCteFocusGained(evt);
            }
            else if (evt.getSource() == montoField) {
                FrameCobrarTransferencias.this.montoFieldFocusGained(evt);
            }
        }
        ...
        public void keyPressed(java.awt.event.KeyEvent evt) {
            if (evt.getSource() == txtCtaCte) {
                FrameCobrarTransferencias.this.txtCtaCteKeyPressed(evt);
            }
        }

        public void keyReleased(java.awt.event.KeyEvent evt) {
            if (evt.getSource() == txtCtaCte) {
                FrameCobrarTransferencias.this.txtCtaCteKeyReleased(evt);
            }
        }

        public void keyTyped(java.awt.event.KeyEvent evt) {
            if (evt.getSource() == txtCtaCte) {
                FrameCobrarTransferencias.this.txtCtaCteKeyTyped(evt);
            }
        }

        public void mouseClicked(java.awt.event.MouseEvent evt) {
            if (evt.getSource() == montoField) {
                FrameCobrarTransferencias.this.montoFieldMouseClicked(evt);
            }
        }
        ...
        public void internalFrameActivated(javax.swing.event.InternalFrameEvent evt) {
            if (evt.getSource() == FrameCobrarTransferencias.this) {
                FrameCobrarTransferencias.this.formInternalFrameActivated(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        try {
            ...
            List<com.lacreacion.mg.domain.TblTransferencias> toRemove = new ArrayList<>(selected.length);
            for (int idx = 0; idx < selected.length; idx++) {
                com.lacreacion.mg.domain.TblTransferencias t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
                toRemove.add(t);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        try {
            com.lacreacion.mg.domain.TblTransferencias t = new com.lacreacion.mg.domain.TblTransferencias();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            entityManager.getTransaction().begin();
            List<com.lacreacion.mg.domain.TblTransferencias> merged = new ArrayList<>(list.size());
            for (com.lacreacion.mg.domain.TblTransferencias t : list) {
    ...
    private java.util.List<com.lacreacion.mg.domain.TblTransferencias> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameCobrarTransferencias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new FrameCobrarTransferencias());
