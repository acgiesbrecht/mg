...
public class FrameGruposAdmin extends JInternalFrame {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<com.parah.mg.domain.TblGrupos> toRemove = new ArrayList<>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            com.parah.mg.domain.TblGrupos t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(t);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        com.parah.mg.domain.TblGrupos t = new com.parah.mg.domain.TblGrupos();
    ...
    private java.util.List<com.parah.mg.domain.TblGrupos> list;
