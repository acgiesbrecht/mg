...
public class FrameCategoriasArticulosAdmin extends JInternalFrame {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        try {
            ...
            List<com.parah.mg.domain.TblCategoriasArticulos> toRemove = new ArrayList<>(selected.length);
            for (Integer idx = 0; idx < selected.length; idx++) {
                com.parah.mg.domain.TblCategoriasArticulos t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
                toRemove.add(t);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        try {
            com.parah.mg.domain.TblCategoriasArticulos t = new com.parah.mg.domain.TblCategoriasArticulos();
    ...
    private java.util.List<com.parah.mg.domain.TblCategoriasArticulos> list;
