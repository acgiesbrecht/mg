 ...
 * @author user
 */
public class FrameRubrosDdjjAdmin extends JInternalFrame {

    private static final Logger LOGGER = LogManager.getLogger(FrameRubrosDdjjAdmin.class);
    Map<String, String> persistenceMap = new HashMap<>();

    public FrameRubrosDdjjAdmin() {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT t FROM TblRubrosDdjj t");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                FrameRubrosDdjjAdmin.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                FrameRubrosDdjjAdmin.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                FrameRubrosDdjjAdmin.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                FrameRubrosDdjjAdmin.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        try {
            ...
            List<com.parah.mg.domain.TblRubrosDdjj> toRemove = new ArrayList<>(selected.length);
            for (int idx = 0; idx < selected.length; idx++) {
                com.parah.mg.domain.TblRubrosDdjj t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
                toRemove.add(t);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        try {
            com.parah.mg.domain.TblRubrosDdjj t = new com.parah.mg.domain.TblRubrosDdjj();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            entityManager.getTransaction().begin();
            List<com.parah.mg.domain.TblRubrosDdjj> merged = new ArrayList<>(list.size());
            for (com.parah.mg.domain.TblRubrosDdjj t : list) {
    ...
    private java.util.List<com.parah.mg.domain.TblRubrosDdjj> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameRubrosDdjjAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new FrameRubrosDdjjAdmin());
