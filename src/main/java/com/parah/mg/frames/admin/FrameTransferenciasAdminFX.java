 ...
 * @author Industria
 */
public class FrameTransferenciasAdminFX extends JInternalFrame {

    private static final Logger LOGGER = LogManager.getLogger(FrameTransferenciasAdminFX.class);
    CurrentUser currentUser = CurrentUser.getInstance();
    String databaseIP;
    Map<String, String> persistenceMap = new HashMap<>();

    public FrameTransferenciasAdminFX() {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT t FROM TblTransferencias t JOIN FETCH t.idEntidad ORDER BY t.fechahora");
        ...
        jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, list, jXTable1);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${id}"));
        columnBinding.setColumnName("Id");
        columnBinding.setColumnClass(Integer.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${fechahoraCompromiso}"));
        columnBinding.setColumnName("Fechahora Compromiso");
        columnBinding.setColumnClass(java.time.LocalDate.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${fechahora}"));
        ...
        if (jXTable1.getColumnModel().getColumnCount() > 0) {
            jXTable1.getColumnModel().getColumn(3).setCellRenderer(null);
    ...
    private class FormListener implements java.awt.event.ActionListener, javax.swing.event.InternalFrameListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == deleteButton) {
                FrameTransferenciasAdminFX.this.deleteButtonActionPerformed(evt);
            }
            else if (evt.getSource() == printButton) {
                FrameTransferenciasAdminFX.this.printButtonActionPerformed(evt);
            }
            else if (evt.getSource() == printButton1) {
                FrameTransferenciasAdminFX.this.printButton1ActionPerformed(evt);
            }
        }

        public void internalFrameActivated(javax.swing.event.InternalFrameEvent evt) {
            if (evt.getSource() == FrameTransferenciasAdminFX.this) {
                FrameTransferenciasAdminFX.this.formInternalFrameActivated(evt);
            }
        }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameTransferenciasAdminFX.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new FrameTransferenciasAdminFX());
