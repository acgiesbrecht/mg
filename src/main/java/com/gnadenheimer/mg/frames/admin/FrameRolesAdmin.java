...
public class FrameRolesAdmin extends JInternalFrame {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<com.gnadenheimer.mg.domain.TblRoles> toRemove = new ArrayList<com.gnadenheimer.mg.domain.TblRoles>(selected.length);
        for (Integer idx = 0; idx < selected.length; idx++) {
            com.gnadenheimer.mg.domain.TblRoles t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(t);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        com.gnadenheimer.mg.domain.TblRoles t = new com.gnadenheimer.mg.domain.TblRoles();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            LOGGER.error(Thread.currentThread().getStackTrace()[1].getMethodName(), ex);
            entityManager.getTransaction().begin();
            List<com.gnadenheimer.mg.domain.TblRoles> merged = new ArrayList<com.gnadenheimer.mg.domain.TblRoles>(list.size());
            for (com.gnadenheimer.mg.domain.TblRoles t : list) {
    ...
    private java.util.List<com.gnadenheimer.mg.domain.TblRoles> list;
