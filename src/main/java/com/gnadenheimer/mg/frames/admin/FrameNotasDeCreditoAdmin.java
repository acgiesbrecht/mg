 ...
 * @author Industria
 */
public class FrameNotasDeCreditoAdmin extends JInternalFrame {

    private static final Logger LOGGER = LogManager.getLogger(FrameNotasDeCreditoAdmin.class);
    CurrentUser currentUser = CurrentUser.getInstance();
    String databaseIP;
    Map<String, String> persistenceMap = new HashMap<>();

    public FrameNotasDeCreditoAdmin() {
        super("Administrar Notas de Credito",
                true, //resizable
                true, //closable
                true, //maximizable
                true);//iconifiable
    ...
    private void initComponents() {
        ...
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${nroFactura.nro}"));
        ...
        columnBinding.setEditable(false);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${nroFactura.razonSocial}"));
        columnBinding.setColumnName("Razon Social");
        columnBinding.setColumnClass(String.class);
        columnBinding.setEditable(false);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${nroFactura.ruc}"));
        columnBinding.setColumnName("RUC");
        columnBinding.setColumnClass(String.class);
        columnBinding.setEditable(false);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${nroFactura.importeAporte}"));
        columnBinding.setColumnName("Importe Aporte");
        columnBinding.setColumnClass(Integer.class);
        columnBinding.setEditable(false);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${nroFactura.importeDonacion}"));
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == anularButton) {
                FrameNotasDeCreditoAdmin.this.anularButtonActionPerformed(evt);
            }
            else if (evt.getSource() == imprimirButton) {
                FrameNotasDeCreditoAdmin.this.imprimirButtonActionPerformed(evt);
            }
        }
    ...
    private void imprimirButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imprimirButtonActionPerformed
        try {
            if (masterTable.getSelectedRow() > -1) {
                TblNotasDeCredito notaDeCredito = list.get(masterTable.convertRowIndexToModel(masterTable.getSelectedRow()));
    ...
    private void anularButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_anularButtonActionPerformed
        try {
            ...
            LOGGER.error(Thread.currentThread().getStackTrace()[1].getMethodName(), ex);
            entityManager.getTransaction().begin();
            List<com.gnadenheimer.mg.domain.TblNotasDeCredito> merged = new ArrayList<>(list.size());
            for (com.gnadenheimer.mg.domain.TblNotasDeCredito t : list) {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameNotasDeCreditoAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new FrameNotasDeCreditoAdmin());
