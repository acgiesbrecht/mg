...
public class FrameTimbradosAutofacturasAdmin extends JInternalFrame {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<com.gnadenheimer.mg.domain.TblTimbradosAutofacturas> toRemove = new ArrayList<>(selected.length);
        for (Integer idx = 0; idx < selected.length; idx++) {
            com.gnadenheimer.mg.domain.TblTimbradosAutofacturas t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(t);
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            entityManager.getTransaction().begin();
            List<com.gnadenheimer.mg.domain.TblTimbradosAutofacturas> merged = new ArrayList<>(list.size());
            for (com.gnadenheimer.mg.domain.TblTimbradosAutofacturas t : list) {
    ...
    private java.util.List<com.gnadenheimer.mg.domain.TblTimbradosAutofacturas> list;
