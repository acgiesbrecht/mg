...
public class FrameRecibosAdmin extends JInternalFrame {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT t FROM TblRecibos t WHERE EXTRACT(YEAR FROM t.fechahora) = :anoActivo");
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        try {
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                List<com.gnadenheimer.mg.domain.TblRecibos> toRemove = new ArrayList<>(selected.length);
                for (Integer idx = 0; idx < selected.length; idx++) {
                    com.gnadenheimer.mg.domain.TblRecibos t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
                    toRemove.add(t);
    ...
    private java.util.List<com.gnadenheimer.mg.domain.TblRecibos> list;
