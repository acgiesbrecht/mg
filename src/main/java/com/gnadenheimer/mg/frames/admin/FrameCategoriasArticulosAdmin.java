...
public class FrameCategoriasArticulosAdmin extends JInternalFrame {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT t FROM TblCategoriasArticulos t WHERE t.id > 2");
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        try {
            ...
            List<com.gnadenheimer.mg.domain.TblCategoriasArticulos> toRemove = new ArrayList<>(selected.length);
            for (Integer idx = 0; idx < selected.length; idx++) {
                com.gnadenheimer.mg.domain.TblCategoriasArticulos t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
                toRemove.add(t);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        try {
            com.gnadenheimer.mg.domain.TblCategoriasArticulos t = new com.gnadenheimer.mg.domain.TblCategoriasArticulos();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            entityManager.getTransaction().begin();
            List<com.gnadenheimer.mg.domain.TblCategoriasArticulos> merged = new ArrayList<>(list.size());
            for (com.gnadenheimer.mg.domain.TblCategoriasArticulos t : list) {
    ...
    private java.util.List<com.gnadenheimer.mg.domain.TblCategoriasArticulos> list;
