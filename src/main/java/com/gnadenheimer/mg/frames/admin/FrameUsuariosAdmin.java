...
import com.gnadenheimer.mg.domain.TblGrupos;
...
public class FrameUsuariosAdmin extends JInternalFrame {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<com.gnadenheimer.mg.domain.TblUsers> toRemove = new ArrayList<>(selected.length);
        for (Integer idx = 0; idx < selected.length; idx++) {
            com.gnadenheimer.mg.domain.TblUsers t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(t);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        com.gnadenheimer.mg.domain.TblUsers t = new com.gnadenheimer.mg.domain.TblUsers();
    ...
    private java.util.List<com.gnadenheimer.mg.domain.TblUsers> list;
    private java.util.List<com.gnadenheimer.mg.domain.TblGrupos> listGrupos;
    private java.util.List<com.gnadenheimer.mg.domain.TblRoles> listRoles;
