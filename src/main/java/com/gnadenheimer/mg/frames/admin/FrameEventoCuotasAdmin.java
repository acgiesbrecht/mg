...
public class FrameEventoCuotasAdmin extends JInternalFrame {
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            LOGGER.error(Thread.currentThread().getStackTrace()[1].getMethodName(), ex);
            entityManager.getTransaction().begin();
            List<com.gnadenheimer.mg.domain.TblEventoCuotas> merged = new ArrayList<>(list.size());
            for (com.gnadenheimer.mg.domain.TblEventoCuotas t : list) {
    ...
    private java.util.List<com.gnadenheimer.mg.domain.TblEventoCuotas> list;
