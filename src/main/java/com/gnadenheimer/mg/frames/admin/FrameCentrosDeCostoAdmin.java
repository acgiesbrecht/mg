...
public class FrameCentrosDeCostoAdmin extends JInternalFrame {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        try {
            ...
            List<com.gnadenheimer.mg.domain.TblCentrosDeCosto> toRemove = new ArrayList<>(selected.length);
            for (Integer idx = 0; idx < selected.length; idx++) {
                com.gnadenheimer.mg.domain.TblCentrosDeCosto t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
                toRemove.add(t);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        try {
            com.gnadenheimer.mg.domain.TblCentrosDeCosto t = new com.gnadenheimer.mg.domain.TblCentrosDeCosto();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            entityManager.getTransaction().begin();
            List<com.gnadenheimer.mg.domain.TblCentrosDeCosto> merged = new ArrayList<>(list.size());
            for (com.gnadenheimer.mg.domain.TblCentrosDeCosto t : list) {
