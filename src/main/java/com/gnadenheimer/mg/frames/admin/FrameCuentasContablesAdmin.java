...
public class FrameCuentasContablesAdmin extends JInternalFrame {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        try {
            ...
            List<com.gnadenheimer.mg.domain.TblCuentasContables> toRemove = new ArrayList<>(selected.length);
            for (Integer idx = 0; idx < selected.length; idx++) {
                com.gnadenheimer.mg.domain.TblCuentasContables t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
                toRemove.add(t);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        try {
            com.gnadenheimer.mg.domain.TblCuentasContables t = new com.gnadenheimer.mg.domain.TblCuentasContables();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            entityManager.getTransaction().begin();
            List<com.gnadenheimer.mg.domain.TblCuentasContables> merged = new ArrayList<>(list.size());
            for (com.gnadenheimer.mg.domain.TblCuentasContables t : list) {
    ...
    private com.gnadenheimer.mg.utils.CuentaContableCellRenderer cuentaContableCellRenderer1;
    ...
    private java.util.List<com.gnadenheimer.mg.domain.TblCuentasContables> list;
