...
public class FrameEventosAdmin extends JInternalFrame {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT t FROM TblEventos t WHERE t.idGrupo IN :grupos AND EXTRACT(YEAR FROM t.fecha) = :anoActivo  ORDER BY t.fecha");
        ...
        dateToStringConverterInverse1 = new com.gnadenheimer.mg.utils.DateToStringConverterInverse();
        ...
        columnBinding.setColumnClass(com.gnadenheimer.mg.domain.TblGrupos.class);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        try {
            ...
            List<com.gnadenheimer.mg.domain.TblEventos> toRemove = new ArrayList<>(selected.length);
            for (Integer idx = 0; idx < selected.length; idx++) {
                com.gnadenheimer.mg.domain.TblEventos t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
                toRemove.add(t);
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            LOGGER.error(Thread.currentThread().getStackTrace()[1].getMethodName(), ex);
            entityManager.getTransaction().begin();
            List<com.gnadenheimer.mg.domain.TblEventos> merged = new ArrayList<>(list.size());
            for (com.gnadenheimer.mg.domain.TblEventos t : list) {
    ...
    private com.gnadenheimer.mg.utils.DateToStringConverterInverse dateToStringConverterInverse1;
    ...
    private java.util.List<com.gnadenheimer.mg.domain.TblEventos> list;
