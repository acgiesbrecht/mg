...
public class FrameFacturasCompra extends JInternalFrame {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        try {
            ...
            List<com.gnadenheimer.mg.domain.TblFacturasCompra> toRemove = new ArrayList<>(selected.length);
            for (Integer idx = 0; idx < selected.length; idx++) {
                com.gnadenheimer.mg.domain.TblFacturasCompra t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
                toRemove.add(t);
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            LOGGER.error(Thread.currentThread().getStackTrace()[1].getMethodName(), ex);
            entityManager.getTransaction().begin();
            List<com.gnadenheimer.mg.domain.TblFacturasCompra> merged = new ArrayList<>(list.size());
            for (com.gnadenheimer.mg.domain.TblFacturasCompra t : list) {
    ...
    private java.util.List<com.gnadenheimer.mg.domain.TblFacturasCompra> list;
    ...
    private java.util.List<com.gnadenheimer.mg.domain.TblFacturasCompra> listTimbrados;
