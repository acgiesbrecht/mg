...
public class FrameCobrarTransferenciasAyCporMes extends JInternalFrame implements TableModelListener {
    ...
    void refresh() {
        try {
            if (cboEventoTipo.getSelectedItem() != null && entityManager.getTransaction().isActive()) {
                ...
                entityManager.getTransaction().begin();
                /*SELECT new com.gnadenheimer.mg.domain.models.PagosMensualesPendientes(e,
 ...
 /*query = entityManager.createNativeQuery("SELECT eventodetalle.id,"
    ...
    private java.util.List<com.gnadenheimer.mg.domain.models.PagosMensualesPendientes> list;
