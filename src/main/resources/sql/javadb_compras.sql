...
CREATE TABLE MG.TBL_CUENTAS_CONTABLES_POR_DEFECTO (
    ID INTEGER NOT NULL,
    ID_CUENTA_IVA_CREDITO INTEGER DEFAULT 101020100 NOT NULL,
...
ALTER TABLE MG.TBL_CUENTAS_CONTABLES_POR_DEFECTO
	ADD FOREIGN KEY (ID_CUENTA_IVA_CREDITO) REFERENCES MG.TBL_CUENTAS_CONTABLES (ID);
...
ALTER TABLE MG.TBL_AUTOFACTURAS
	ADD FOREIGN KEY (NRO_TIMBRADO) REFERENCES MG.TBL_TIMBRADOS_AUTOFACTURAS (NRO);

ALTER TABLE MG.TBL_ASIENTOS
	ADD FOREIGN KEY (ID_USER) REFERENCES MG.TBL_USERS (ID);

INSERT INTO MG.TBL_CENTROS_DE_COSTO (DESCRIPCION) VALUES ('Interner Haushalt');
INSERT INTO MG.TBL_CENTROS_DE_COSTO (DESCRIPCION) VALUES ('Jugend');
...
INSERT INTO MG.TBL_CUENTAS_CONTABLES (ID, DESCRIPCION, ID_CUENTA_MADRE, IMPUTABLE) VALUES (101020100, 'IVA Credito Fiscal',101020000,TRUE);
