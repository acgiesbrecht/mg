...
ALTER TABLE MG.TBL_ASIENTOS
	ADD FOREIGN KEY (ID_CUENTA_CONTABLE_DEBE)
	REFERENCES MG.TBL_CUENTAS_CONTABLES (ID);

ALTER TABLE MG.TBL_ASIENTOS
	ADD FOREIGN KEY (ID_CUENTA_CONTABLE_HABER)
	REFERENCES MG.TBL_CUENTAS_CONTABLES (ID);
...
INSERT INTO MG.TBL_CUENTAS_CONTABLES (ID, DESCRIPCION, ID_CUENTA_MADRE, IMPUTABLE) VALUES (501010800, 'Utiles para Cocina',501010000,TRUE);
INSERT INTO MG.TBL_CUENTAS_CONTABLES (ID, DESCRIPCION, ID_CUENTA_MADRE, IMPUTABLE) VALUES (501010900, 'Utiles para Patio',501010000,TRUE);