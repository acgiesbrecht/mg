...
/*
CREATE TRIGGER MG.EVENTO_DETALLE_PAGO
AFTER
INSERT
ON MG.TBL_EVENTO_DETALLE
REFERENCING NEW AS new_row
FOR EACH ROW
MODE DB2SQL
CASE
WHEN new_row.ID_FORMA_DE_PAGO_PREFERIDA = 1 THEN
    INSERT INTO MG.TRANSFERENCIAS (new_row.FECHAHORA,
	CONCEPTO,
	MONTO,
	PORCENTAJE_APORTE,
	ID_ENTIDAD,
        ...
        COBRADO,
	ID_USER) VALUES
        (SELECT DESCRIPCION FROM TBL_EVENTOS WHERE ID = new_row.ID_EVENTO,
        new_row.MONTO,
        SELECT PORCENTAJE_APORTE FROM TBL_EVENTOS WHERE ID = new_row.ID_EVENTO,
        new_row.ID_ENTIDAD,
        new_row.ID_EVENTO,
        FALSE,
        new_row.ID_USER)
ELSE
    INSERT INTO MG.RECIBOS (new_row.FECHAHORA,
	CONCEPTO,
	MONTO,
	PORCENTAJE_APORTE,
	ID_ENTIDAD,
